oscal_catalog_j_schema = {
  ...
  "types": [
    ...
    ["Resource", "Record", [], "A resource associated with content in the containing document instance. A resource may be directly included in the document using base64 encoding or may point to one or more equivalent internet resources.", [
        ...
        [6, "citation", "Citation", ["[0"], "An optional citation consisting of end note text using structured markup."],
    ...
    ["Citation", "Record", [], "A document identifier qualified by an identifier scheme.", [
        [1, "text", "String", ["[0"], "Citation Text."]
      ]],
