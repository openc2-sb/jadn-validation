...
oscal_ar_j_schema = {
  "meta": {
    "package": "http://csrc.nist.gov/ns/oscal/1.1.1/oscal-ar-schema.json",
  ...
  "types": [
    ["Root", "Record", [], "", [
      ...
      [2, "assessment-results", "Assessment-results", [], "Security assessment results, such as those provided by a FedRAMP assessor in the FedRAMP Security Assessment Report."]
    ]],
    ...
    ["Assessment-results", "Record", [], "Security assessment results, such as those provided by a FedRAMP assessor in the FedRAMP Security Assessment Report.", [
      [1, "uuid", "UUIDDatatype", [], "A machine-oriented, globally unique identifier with cross-instance scope that can be used to reference this assessment results instance in this or other OSCAL instances. The locally defined UUID of the assessment result can be used to reference the data item locally or globally (e.g., in an imported OSCAL instance). This UUID should be assigned per-subject, which means it should be consistently used to identify the same subject across revisions of the document."],
      ...
      [3, "import-ap", "Import-ap", [], "Used by assessment-results to import information about the original plan for assessing the system."],
      ...
      [5, "results", "Results", [], "Used by the assessment results and POA&M. In the assessment results, this identifies all of the assessment observations and findings, initial and residual risks, deviations, and disposition. In the POA&M, this identifies initial and residual risks, deviations, and disposition."],
    ...
    ["Result", "Record", [], "Used by the assessment results and POA&M. In the assessment results, this identifies all of the assessment observations and findings, initial and residual risks, deviations, and disposition. In the POA&M, this identifies initial and residual risks, deviations, and disposition.", [
      [1, "uuid", "UUIDDatatype", [], "A machine-oriented, globally unique identifier with cross-instance scope that can be used to reference this set of results in this or other OSCAL instances. The locally defined UUID of the assessment result can be used to reference the data item locally or globally (e.g., in an imported OSCAL instance). This UUID should be assigned per-subject, which means it should be consistently used to identify the same subject across revisions of the document."],
      ...
      [4, "start", "DateTimeWithTimezoneDatatype", [], "Date/time stamp identifying the start of the evidence collection reflected in these results."],
      [5, "end", "DateTimeWithTimezoneDatatype", ["[0"], "Date/time stamp identifying the end of the evidence collection reflected in these results. In a continuous motoring scenario, this may contain the same value as start if appropriate."],
      ...
      [8, "local-definitions", "Local-Definitions", ["[0"], "Used to define data objects that are used in the assessment plan, that do not appear in the referenced SSP."],
      [9, "reviewed-controls", "Reviewed-controls", [], "Identifies the controls being assessed and their control objectives."],
      [10, "attestations", "Attestations", ["[0"], "A set of textual statements, typically written by the assessor."],
      [11, "assessment-log", "ArrayOf", ["*Assessment-Log-Entry", "[0"], "A log of all assessment-related actions taken."],
      [12, "observations", "Observations", ["[0"], "Describes an individual observation."],
      [13, "risks", "Risks", ["[0"], "An identified risk."],
      [14, "findings", "Findings", ["[0"], "Describes an individual finding."],
      [15, "remarks", "Remarks", ["[0"], "Additional commentary about the containing object."]
    ]],

    ["Assessment-Log-Entry", "Record", [], "Identifies the result of an action and/or task that occurred as part of executing an assessment plan or an assessment event that occurred in producing the assessment results.", [
        [1, "title", "String", ["[0", "]1"], "The title for this event."],
        [2, "description", "String", [], "A human-readable description of this event."],
        ...
        [8, "related-risks", "ArrayOf", ["*Related-risk", "[0", "]0"], ""],
        [9, "remarks", "String", [], ""]
      ]],
    ...
    ["Attestations", "ArrayOf", ["{1", "*Attestation"], "", []],

    ["Attestation", "Record", [], "A set of textual statements, typically written by the assessor.", [
      [1, "responsible-parties", "Responsible-parties", ["[0"], "A reference to a set of persons and/or organizations that have responsibility for performing the referenced role in the context of the containing object."],
      [2, "parts", "Assessment-Parts", [], "A partition of an assessment plan or results or a child of another part."]
    ]],
    ...
    ["Import-ap", "Record", [], "Used by assessment-results to import information about the original plan for assessing the system.", [
      [1, "href", "URIReferenceDatatype", [], "A resolvable URL reference to the assessment plan governing the assessment activities."],
...
def test_oscal_ar_schema():
  is_errors = False
  try :
      j_validation = DataValidation(j_meta_schema, j_meta_roots, oscal_ar_j_schema)
